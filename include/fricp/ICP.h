...
namespace RigidMotionEstimator {
    ...
    Eigen::Affine3d point_to_point(Eigen::MatrixBase<Derived1>& X,
        ...
        DWIO::MatrixXX sigma = X * w_normalized.asDiagonal() * Y.transpose();
        Eigen::JacobiSVD<DWIO::MatrixXX> svd(sigma, Eigen::ComputeFullU | Eigen::ComputeFullV);
        if (svd.matrixU().determinant()*svd.matrixV().determinant() < 0.0) {
            DWIO::VectorX S = DWIO::VectorX::Ones(dim); S(dim-1) = -1.0;
...
namespace ICP {
    ...
    namespace AAICP{
        typedef Eigen::Matrix<Scalar, 3, 1> Vector3;
            ...
            ///aaicp
            ///////////////////////////////////////////////////////////////////////////////////////////
            inline Vector6 Matrix42Vector6 (const Matrix4 m)
            {
              Vector6 v;
            ...
            ///////////////////////////////////////////////////////////////////////////////////////////
            inline Matrix4 Vector62Matrix4 (const Vector6 v)
            {
            ...
            ///////////////////////////////////////////////////////////////////////////////////////////
            inline int alphas_cond (VectorX alphas)
            {
            ...
            ///////////////////////////////////////////////////////////////////////////////////////////
            inline VectorX get_alphas_lstsq (const Matrix6X f)
            {
            ...
            template <typename Derived1, typename Derived2, typename Derived3>
            inline void point_to_point_aaicp(Eigen::MatrixBase<Derived1>& X,Eigen::MatrixBase<Derived2>& Y, Eigen::MatrixBase<Derived3>& source_mean,
                ...
                DWIO::MatrixXX To1 =T.matrix();
                DWIO::MatrixXX To2 = T.matrix();
