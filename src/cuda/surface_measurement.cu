...
//                printf("[Surface measurement] Vertex: %f %f %f \n", vertex.x(), vertex.y(), vertex.z());
            ...
            __global__
            void kernel_compute_ground_vertx(PtrStep<float3> ground_vertex, PtrStep<float3> non_ground_vertex,
...
//                printf("[Surface measurement] Normal: %f %f %f \n", normal.x(), normal.y(), normal.z());
            ...
            __global__
            void compute_parallel_label_kernel(const PtrStepSz<float3> vertex_map, const PtrStepSz<float3> normal_map,
            ...
            __global__
            void filterDepth_device(PtrStepSz<float> depth_temp,
            ...
            void compute_vertex_map(FrameData &frame_data, const float depth_cutoff_max,
                ...
                filterDepth_device <<< blocks, threads >>>
                        (frame_data.depth_temp, frame_data.depth_map, cam_params, 50.0f, 0.3f);
                ...
                kernel_compute_vertex_map<<<blocks, threads>>>
                        (frame_data.depth_map, frame_data.vertex_map, depth_cutoff_max, depth_cutoff_min, cam_params);
            ...
            void compute_ground_vertex(FrameData &frame_data, const CameraConfiguration cam_params) {
                ...
                kernel_compute_ground_vertx<<<blocks, threads>>>
                        (frame_data.ground_vertex, frame_data.non_ground_vertex, frame_data.vertex_map, cam_params);
